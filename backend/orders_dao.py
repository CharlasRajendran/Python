...
def insert_order(connection1, order):
...
def get_order_details(connection2, order_id):
...
def get_all_orders(connection3):
    ...
    for record in response:
        record['order_details'] = get_order_details(connection3, record['order_id'])
